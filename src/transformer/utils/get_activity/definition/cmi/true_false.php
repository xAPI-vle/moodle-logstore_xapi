...
/**
 * Transformer utilities for creating CMI true-false xAPI Activity object definitions.
 *
 ...
 * @param ?bool $correctanswer The correct true/false answer.
 */
function true_false(
    array $config,
    string $name,
