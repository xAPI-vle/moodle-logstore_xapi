...
class RemoteLRS implements LRSInterface
{
    ...
    public function saveStatement($statement) {
        ...
        //$statementraw = json_encode($statement->asVersion($this->version), JSON_UNESCAPED_SLASHES);
        
        //error_log("STATEMENT SENT");
        //error_log(print_r($statementraw, true));
        
        //error_log("RESPONSE FROM LEARNING LOCKER");
