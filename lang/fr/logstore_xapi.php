...
/**
 * French log store lang strings.
 *
 * @package   logstore_xapi
 * @copyright AJOUTER NOM
...
$string['actionsdescription'] = 'The selection by default includes no actions. Actions must be manually set to be included.';
...
$string['pseudo'] = 'Enable pseudonymization of users';
$string['pseudo_desc'] = 'User identification statement will be pseudonymized when this box is ticked.';
$string['pseudo_text'] = 'Hash key';
$string['pseudo_text_desc'] = 'If the pseudonymization is enabled, this secret key will be used for hashing.';
