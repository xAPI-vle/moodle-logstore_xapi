...
$string['modulename'] = 'Logstore Emitter';
$string['modulenameplural'] = 'Emitters';
$string['modulename_help'] = 'Use the logstore emitter module for... | The logstore emitter plugin allows...';
...
$string['pluginadministration'] = 'Logstore Emitter administration';
$string['pluginname'] = 'Logstore Emitter';
$string['submit'] = 'Submit';
$string['username'] = 'Username';
$string['xapisettingstitle'] = 'Logstore Emitter Settings';