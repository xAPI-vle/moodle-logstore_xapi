...
$string['send_useridnumber'] = 'Identify users by user\'s idnumber';
$string['send_useridnumber_desc'] = 'Statements will identify users with their idnumber when this box is ticked, but only if identifying users by email is disabled.';
