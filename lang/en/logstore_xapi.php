...
$string['send_bestr_data'] = 'Adds bestr data to statements';
$string['send_bestr_data_desc'] = 'Statements will contain data required by bestr.';
$string['bestr_custom_birthdate'] = 'Adds birthdate to statements';
$string['bestr_custom_birthdate_desc'] = 'Insert the name of the field where the birthdate data is in.';
$string['bestr_custom_cf'] = 'Adds italian fiscal code data to statements';
$string['bestr_custom_cf_desc'] = 'Insert the name of the field where the italian fiscal code data is in.';
