...
class viewed extends Verb 
{
    public function __construct() {
        $this->_id = 'http://id.tincanapi.com/verb/viewed';
        $this->_name['en-US'] = 'viewed';
        $this->_logstoreEventName['mod_scorm'] = '\\mod_scorm\\event\\course_module_viewed';
    }
}