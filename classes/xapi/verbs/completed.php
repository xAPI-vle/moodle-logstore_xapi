...
class completed extends Verb
{
    public function __construct() {
        $this->_id = 'http://activitystrea.ms/schema/1.0/complete';
        $this->_name['en-US'] = 'completed';
        $this->_logstoreEventName['core'] = '\\core\\event\\course_completed';
    }
}