...
class ServiceTest extends BaseTest {
    ...
    public function setup() {
        $this->service = new translator_service();
    }

    /**
     * Tests the read_course_viewed_event method of the translator_service.
     */
    ...
    /**
     * Tests the read_module_viewed_event method of the translator_service.
     */
    ...
    /**
     * Tests the read_attempt_started_event method of the translator_service.
     */
    ...
    /**
     * Tests the read_attempt_reviewed_event method of the translator_service.
     */
    public function testReadAttemptReviewedEvent() {
        $test_data = $this->constructAttemptReviewed();
        $event = $this->service->read_attempt_reviewed_event($test_data);
        $this->assertAttemptReviewed($test_data, $event);
    }

    /**
     * Tests the read_user_loggedin_event method of the translator_service.
     */
    ...
    /**
     * Tests the read_user_loggedout_event method of the translator_service.
     */
    ...
    /**
     * Tests the read_assignment_graded_event method of the translator_service.
     */
    ...
    /**
     * Tests the read_assignment_submitted_event method of the translator_service.
     */
